    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <section id="about" class="section min-h-[90vh] bg-white text-center">
            <div class="flex justify-center items-center relative">
                <div class="bg-design bg-[#FFDED6] flex justify-center items-center w-full md:w-1/2 gap-5 py-2 px-4 md:px-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:px-[150px] mx-4 pt-7 pb-5 relative sm:px-[150px]">
                <div class="bg-[#694F8E] min-h-[40vh] lg:min-h-[57vh] rounded-xl flex flex-col items-center p-4 md:px-5 gap-4">
                    ...
                    <div class="h-[40%]">
                        <h1 class="text-justify text-base md:text-lg text-[#FFDED6]">
                            ...
                            SPEAK, or Speech Potential Enhanced through Applied Knowledge, is an online platform accessible to its targeted end users, which are adults with dysarthria. It aims to provide exercises or practices leading to improvement of the patients' speech. By using evidence-based techniques, SPEAK empowers users to take control of their speech rehabilitation journey in a convenient, virtual setting.
                        </h1>
                    </div>
                </div>
                ...
                <div class="bg-[#694F8E] min-h-[40vh] lg:min-h-[57vh] rounded-xl flex flex-col items-center p-4 md:px-5 gap-4">
                    ...
                    <div class="h-[40%]">
                        <h1 class="text-justify text-base md:text-xl text-[#FFDED6]">
                            <span class="ml-4 md:ml-8"></span>
                            At SPEAK, insights and knowledge from Professional Speech Language Pathologists (SLPs) are highly valued and incorporated in the whole website development process. Through this collaboration, their expertise ensures that the platform provides scientifically-backed, effective strategies for managing dysarthria.
                        </h1>
                    </div>
                </div>
                ...
                <div class="bg-[#694F8E] min-h-[40vh] lg:min-h-[57vh] rounded-xl flex flex-col items-center p-4 md:px-5 gap-4">
                    ...
                    <div class="h-[40%]">
                        <h1 class="text-justify text-base md:text-xl text-[#FFDED6]">
                            <span class="ml-4 md:ml-8"></span>
                            SPEAK also offers valuable resources for caregivers, ensuring they are equipped to support the patient’s progress at home. These resources offer guidance on how to implement at-home practices, foster a supportive environment, and address challenges that may arise during the rehabilitation process.
                        </h1>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center mr-4 md:justify-end sm:justify-end mt-5">
                <a href="#developers" class="text-[#694F8E] italic flex items-center text-2xl md:text-3xl font-semibold hover:underline transition-all">
                    Developers
                    <svg class="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M13 5l7 7-7 7M5 12h14" />
                    </svg>
        ...
        <section id="developers" class="section min-h-[80vh] bg-white text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-10 px-4 md:px-[100px] pt-10 pb-5 relative">
                <div class="h-[15rem] md:h-[20rem] w-[15rem] md:w-[20rem] flex flex-col justify-center items-center mx-auto relative ">
                    <div class="bg-[#694F8E] h-[12rem] md:h-[15rem] w-[12rem] md:w-[15rem] rounded-full overflow-hidden flex items-center justify-center">
                        <img src="{{url('img/toga.png')}}" alt="" class="rounded-full w-full h-full object-cover">
                    </div>
                    <h1 class="bg-[#A6A6A6] text-white text-base md:text-lg font-semibold rounded-xl mt-2 px-2 absolute bottom-[10px] sm:bottom-[20px]">
            ...
            <div class="flex justify-center md:justify-end mr-4 md:mr-[150px] my-5">
                <a href="" class="text-[#694F8E] italic flex items-center text-2xl md:text-3xl font-semibold hover:underline transition-all">
                    Contact Us
                    <svg class="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M13 5l7 7-7 7M5 12h14" />
                    </svg>
        ...
        <section id="catalog" class="section min-h-[270vh] bg-white">
            <!---------------------- Catalog Header ---------------------->
            <div class="px-10 md:px-[150px] sticky py-5  bg-[#FFDED6] z-[2] top-[50px]">
            ...
            <div class="">
                <div class="px-4 md:px-[150px] sticky py-5 top-[50px] flex justify-end z-[2]">
                    <h1 class="text-[#694F8E] text-[1.6rem] md:text-[2.5rem] font-semibold px-3 rounded-2xl">Stories</h1>
                </div>
                <div class="flex flex-col md:flex-row gap-5 md:gap-10 px-4 sm:px-[150px] md:px-[100px] pt-10 pb-5 relative">
                    <div class="w-full md:w-[50%] p-5 items-center bg-[#fff] shadow-xl rounded-lg hover:bg-[#ffded627] transition-all">
            ...
            <div class="">
                <div class="px-4 md:px-[150px] sticky py-5 top-[50px] flex justify-end z-[2]">
                    <h1 class="text-[#694F8E] text-[1.6rem] md:text-[2.5rem] font-semibold px-3 rounded-2xl">Articles</h1>
                </div>
                <div class="flex flex-col md:flex-row gap-5 md:gap-10 px-4 md:px-[100px] pt-10 pb-5 relative">
                    <div class="w-full md:w-[50%] p-5 items-center bg-[#fff] shadow-xl rounded-lg hover:bg-[#ffded627] transition-all">
                        <img src="{{url('img/blank.webp')}}" alt="" class="h-[35vh] w-full mb-4 object-cover">
                        <a href="" class="text-lg text-black">
                            <i class="fa-solid fa-globe"></i> Philippines
            ...
            <div class="">
                <div class="px-4 md:px-[150px] sticky py-5 top-[50px] flex justify-end z-[2]">
                    <h1 class="text-[#694F8E] text-[1.6rem] md:text-[2.5rem] font-semibold px-3 rounded-2xl">Content Creators</h1>
                </div>
                <div class="flex flex-wrap gap-5 justify-center px-4 md:px-[100px] pt-10 pb-5 relative">
                    <div class="min-h-[20rem] w-[90%] md:w-[20rem] p-4">
                        ...
                        <div class="text-black">
                            ...
                            <h2>- Provided direct and indirect speech therapy services to 350 students with communication disorders.</h2>
                        </div>
                    </div>
                    <div class="min-h-[20rem] w-[90%] md:w-[20rem] p-4">
                        <div class="flex flex-col justify-center items-center relative">
        ...
        <section id="courses" class="section min-h-[90vh] bg-white">
            ...
            <div class="flex flex-col lg:flex-row h-auto lg:h-[35rem]">
                <div class="bg-[#694F8E] py-5 w-full lg:w-[60%] flex flex-col items-center justify-center">
                    ...
                    <p class="text-lg md:text-xl lg:text-3xl px-5 md:px-10 text-justify leading-7 md:leading-8 lg:!leading-[2.5rem] font-semibold text-white pt-5">
                    ...
                    <a href="{{route ('login')}}" class="bg-[#b692c2] px-3 py-2 md:px-4 md:py-2 font-semibold mt-5 text-lg md:text-2xl text-white rounded-full">
        ...
        <section id="directory" class="section min-h-[90vh] bg-white">
            <div class="bg-[#FFDED6] w-full flex justify-center items-center gap-5 py-2 px-5">
                <h1 class="text-[#694F8E] text-[2rem] md:text-[3rem] lg:text-[4rem] font-semibold text-center">Meet Our Speech-Language Pathologists!</h1>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-5 md:px-[50px] lg:px-[100px] pb-5 relative">
                <div class="h-auto w-full max-w-[30rem] flex flex-col justify-center items-center mt-10 lg:mt-[100px] mx-auto">
                    ...
                    <div class="text-black px-5 md:px-12 mt-5">
                ...
                <!-- Duplicate sections for other speech-language pathologists -->
                <div class="h-auto w-full max-w-[30rem] flex flex-col justify-center items-center mt-10 lg:mt-[100px] mx-auto">
                    <div class="bg-[#694F8E] h-[12rem] w-[12rem] md:h-[15rem] md:w-[15rem] rounded-full relative flex justify-center overflow-hidden">
                        <img src="{{url ('img/toga.png')}}" alt="" class="rounded-full w-full h-full object-cover">
                        <h1 class="bg-[#A6A6A6] text-white text-center text-lg font-semibold rounded-xl absolute bottom-[-15px] px-3 w-full">
        ...
        <section id="testimonials" class="section min-h-[70vh] bg-[#fff7f5]">
            ...
            <div class="carousel-container relative max-w-5xl mx-auto px-4 md:px-6 py-8 md:py-16 overflow-hidden">
                ...
                <!-- Carousel Controls -->
                <button id="prev" class="absolute top-1/2 left-2 md:left-0 transform -translate-y-1/2 bg-[#694F8E] text-white p-2 px-4 rounded-full">❮</button>
                <button id="next" class="absolute top-1/2 right-2 md:right-0 transform -translate-y-1/2 bg-[#694F8E] text-white p-2 px-4 rounded-full">❯</button>
            </div>
        </section>
            ...
            <footer class="flex flex-col lg:flex-row relative w-full">
                ...
                <div class="lg:w-[50%] p-5 lg:p-10 flex flex-col items-center">
                    ...
                    <div class="flex gap-4 justify-center items-center mt-4">
                        <a href="#" aria-label="Facebook" class="text-3xl group transition-transform duration-300 ease-in-out">
                            <i class="fa-brands fa-facebook text-[#694f8e] group-hover:-translate-y-2 transition-all"></i>
                        </a>
                        <a href="#" aria-label="Twitter" class="text-3xl group transition-transform duration-300 ease-in-out">
                            <i class="fa-brands fa-twitter text-[#694f8e] group-hover:-translate-y-2 transition-all"></i>
                        </a>
                        <a href="#" aria-label="Instagram" class="text-3xl group transition-transform duration-300 ease-in-out">
                            <i class="fa-brands fa-instagram text-[#694f8e] group-hover:-translate-y-2 transition-all"></i>
                        </a>
                        <a href="#" aria-label="LinkedIn" class="text-3xl group transition-transform duration-300 ease-in-out">
                            <i class="fa-brands fa-linkedin text-[#694f8e] group-hover:-translate-y-2 transition-all"></i>
                        </a>
                        <a href="#" aria-label="YouTube" class="text-3xl group transition-transform duration-300 ease-in-out">
                            <i class="fa-brands fa-youtube text-[#694f8e] group-hover:-translate-y-2 transition-all"></i>
                        </a>
                    </div>
                </div>
                        ...
                        <form action="" method="POST">
                            <div class="flex flex-col md:flex-row w-full gap-5">
                                <div class="flex flex-col gap-2 w-full text-black">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Your Name" class="border-2 border-[#694F8E] bg-transparent rounded-full px-3 py-2 focus:outline-none focus:border-[#FFDED6]">
                                </div>
                                <div class="flex flex-col gap-2 w-full text-black">
                                    <label for="email" class="text-black font-medium">Email:</label>
                                    <input type="email" name="email" id="email" placeholder="Your Email" class="border-2 border-[#694F8E] bg-transparent rounded-full px-3 py-2 focus:outline-none focus:border-[#FFDED6]">
                                </div>
                            </div>
                            <!-- Message Input -->
                            <div class="flex flex-col gap-2 w-full text-black mt-4">
                                <label for="message" class="text-black font-medium">Message:</label>
                                <textarea name="message" id="message" placeholder="Type your message here" class="border-2 border-[#694F8E] bg-transparent rounded-xl px-3 py-2 focus:outline-none focus:border-[#FFDED6]" rows="1"></textarea>
                            </div>
                            <div class="flex justify-end mt-5">
                                <button type="submit" class="bg-[#FFDED6] px-8 py-2 rounded-xl text-[#694F8E] hover:bg-[#694F8E] hover:text-white transition-colors">
                                    Send
                                </button>
                            </div>
                        </form>
