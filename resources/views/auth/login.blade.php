<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex flex-col justify-center items-center mb-5">
            <img src="{{url('img/Screenshot 2024-11-11 134435.png')}}" alt="Logo" class="w-[50%] sm:w-[40%] md:w-[30%]">
            <p class="text-sm sm:text-md text-gray-500 mt-2 text-center">
        ...
        <div class="flex items-center justify-center mt-4">
            <a href="{{ route('register') }}" class="italic text-gray-400 text-sm hover:text-black">
                Create an account
            </a>
        </div>
    </form>
